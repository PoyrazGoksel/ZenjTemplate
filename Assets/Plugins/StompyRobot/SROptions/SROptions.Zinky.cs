...
public partial class SROptions
{
    ...
    public void LoadCoins(int currentCoins)
    {
        _coins = currentCoins;
    }
    ...
    public int IncreaseLevel
    {
        ...
        {
            _levels = value;
            OnValueChanged(nameof(IncreaseLevel), value);
            SREvents.ChangeLevel?.Invoke(value);
        }
    }
    ...
    [Category("Zinky")]
    [Increment(25)]
    public int Add25Coins
    {
        get { return _coins; }
        set
        {
            _coins = value;
            OnValueChanged(nameof(Add25Coins), value);
            SREvents.AddCoin?.Invoke(value);
        }
    }
    
    [Category("Zinky")]
    [Increment(50)]
    public int Add50Coins
    {
        get { return _coins; }
        set
        {
            _coins = value;
            OnValueChanged(nameof(Add50Coins), value);
            SREvents.AddCoin?.Invoke(value);
        }
    }
    ...
    [Category("Zinky")]
    [Increment(100)]
    public int Add100Coins
    {
        get { return _coins; }
        set
        {
            _coins = value;
            OnValueChanged(nameof(Add100Coins), value);
            SREvents.AddCoin?.Invoke(value);
        }
    }
    ...
    [Category("Zinky")]
    [Increment(1000)]
    public int Add1000Coins
    {
        get { return _coins; }
        set
        {
            _coins = value;
            OnValueChanged(nameof(Add1000Coins), value);
            SREvents.AddCoin?.Invoke(value);
        }
    }
    //
