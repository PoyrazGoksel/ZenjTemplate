    ...
    public class UIParticleSystem : MaskableGraphic
    {
        ...
        protected bool Initialize()
        {
            ...
            if (textureSheetAnimation.enabled)
            {
                ...
                (1f / textureSheetAnimation.numTilesX, 1f / textureSheetAnimation.numTilesY);
            }
        ...
        protected override void OnPopulateMesh(VertexHelper vh)
        {
            ...
            for (int i = 0; i < count; ++ i)
            {
                ...
                if (textureSheetAnimation.enabled)
                {
                    ...
                    (frameProgress * textureSheetAnimation.cycleCount, 1);
                    ...
                    particleUV.x = frame %
                    textureSheetAnimation.numTilesX *
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        Vector2 up = new Vector2(Mathf.Cos(rotation90), Mathf.Sin(rotation90)) *
                        size;
